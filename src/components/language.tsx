...
export const dictionary = {
  en: {
    ...
    "hero.title": "Pick Base tokens. Build your squad. Climb the leaderboard.",
    "hero.subtitle":
      "Mergen Watch League turns Base token watchlists into a weekly browser-game season with character cards, XP, badges, and reputation.",
  ...
  tr: {
    ...
    "hero.title": "Base tokenlarını seç. Squad kur. Liderliğe tırman.",
    "hero.subtitle":
      "Mergen Watch League, Base token watchlistlerini karakter kartları, XP, rozetler ve itibar içeren haftalık browser-game sezonuna dönüştürür.",
